package com.jloveh.uwallpaper.Utils;
...
/**
 * Created by zhoujia on 2017/7/29.
 */
    ...
    public static String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path = FilePath + "temp/crash/";
                File dir = new File(path);
                if (!dir.exists()) {
                    try {
                        boolean mkdirsresult = dir.mkdirs();
                        Log.d(TAG, "generateUri " + path + " result: " + (mkdirsresult ? "succeeded" : "failed"));
                    } catch (Exception e) {
                        Log.e(TAG, "generateUri failed: " + path, e);
                    }
                }
